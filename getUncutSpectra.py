...
def createCondorFile(run):
    ...
    with open('/home/bjs66/CondorFiles/GetUncutSpectra-%s.condor'%run,'w') as f:

        # Fixed program location'
        f.write('Executable = _getUncutSpectra.py\n') #/home/bjs66/anaconda2/bin/python2.7\n')
        ...
        f.write('log = /home/bjs66/Logs/GetUncutSpectra-%s.log\n'%run)
        f.write('Output = /home/bjs66/Outs/GetUncutSpectra-%s.out\n'%run)
        f.write('Error = /home/bjs66/Errs/GetUncutSpectra-%s.err\n'%run)
...
#    runDirs = ['Run-16-06-27-17-50-08','Run-16-07-06-18-25-19','Run-16-07-12-11-44-55']
    ...
    for run in runDirs:
        ...
        cmd = 'condor_submit /home/bjs66/CondorFiles/GetUncutSpectra-%s.condor'%run
        os.system(cmd)
        tm.sleep(1)
