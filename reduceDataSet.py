...
def createCondorFile(run):
    ...
    with open('/home/bjs66/CondorFiles/ReduceDataSet-%s.condor'%run,'w') as f:
        
        # Fixed program location'
        f.write('Executable = _reduceDataSet.py\n') #/home/bjs66/anaconda2/bin/python2.7\n')
        ...
        f.write('log = /home/bjs66/Logs/ReduceDataSet-%s.log\n'%run)
        f.write('Output = /home/bjs66/Outs/ReduceDataSet-%s.out\n'%run)
        f.write('Error = /home/bjs66/Errs/ReduceDataSet-%s.err\n'%run)
...
#    runDirs = ['Run-16-07-06-18-25-19']
    ...
    for run in runDirs:
        ...
        cmd = 'mkdir -p /home/bjs66/csi/bjs-analysis/Processed/ReducedData/%s'%run
        os.system(cmd)


        createCondorFile(run)
        cmd = 'condor_submit /home/bjs66/CondorFiles/ReduceDataSet-%s.condor'%run
        os.system(cmd)
        tm.sleep(1)
