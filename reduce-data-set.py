...
def createCondorFile(run):
    ...
    with open('/home/bjs66/CondorFiles/ReduceDS-%s.condor'%run,'w') as f:
        ...
        f.write('log = /home/bjs66/Logs/ReduceDS-%s.log\n'%run)
        f.write('Output = /home/bjs66/Outs/ReduceDS-%s.out\n'%run)
        f.write('Error = /home/bjs66/Errs/ReduceDS-%s.err\n'%run)
...
#               'Run-15-11-20-11-34-48','Run-15-11-24-15-35-32','Run-15-12-14-11-21-45'] 
    ...
    for run in runDirs:
        ...
        cmd = 'condor_submit /home/bjs66/CondorFiles/ReduceDS-%s.condor'%run
        os.system(cmd)
        tm.sleep(1)
